...
class ProductEditScreen extends Screen
{
  ...
  public function layout(): iterable
  {
    return [
      Layout::rows([
        Input::make('name')
          ->set('data-controller', 'sluggable-input')
          ->set('data-action', 'input->sluggable-info#onInput')
          ->set('value', $this->getAttr('name'))
          ->title(__('orchid.product.name')),

        Input::make('slug')
          ->set('data-sluggable-target', 'true')
          ->set('value', $this->getAttr('slug'))
          ->title(__('orchid.product.autoGeneratedSlug')),
